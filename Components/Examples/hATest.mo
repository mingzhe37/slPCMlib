...
model hATest
  ...
  Modelica.Blocks.Sources.Ramp ramp(
    height=0.9,
    duration=5,
    offset=0.1) annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
...
equation
  ...
  connect(Twat.y, hATube.T_HTF) annotation (Line(points={{-59,10},{-20,10},{-20,27},{-13,27}}, color={0,0,127}));
  connect(realExpression3.y, hATube.cp) annotation (Line(points={{-59,30},{-18,30},{-18,37},{-13,37}},
                                                                                                color={0,0,127}));
  connect(ramp.y, hATube.theta) annotation (Line(points={{-59,80},{-20,80},{-20,33},{-13,33}}, color={0,0,127}));
end hATest;
