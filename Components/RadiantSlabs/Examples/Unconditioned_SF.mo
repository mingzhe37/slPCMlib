...
model Unconditioned_SF
  ...
  inner Buildings.ThermalZones.EnergyPlus_9_6_0.Building building(
    idfName=Modelica.Utilities.Files.loadResource(
      "modelica://Buildings/Resources/Data/ThermalZones/EnergyPlus_9_6_0/Examples/SingleFamilyHouse_TwoSpeed_ZoneAirBalance/Atlanta_SingleFamily_CZ3A_IECC_2021_ideal_hvac_v96.idf"),
  ...
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam=building.weaName)
...
equation
  ...
  connect(weaDat.weaBus, bou.weaBus) annotation (Line(
      points={{-60,-30},{-46,-30},{-46,-79.8},{-40,-79.8}},
      color={255,204,51},
      thickness=0.5));
  annotation (
    Documentation(
