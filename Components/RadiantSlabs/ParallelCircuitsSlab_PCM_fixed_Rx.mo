...
model ParallelCircuitsSlab_PCM_fixed_Rx "Model of multiple parallel circuits of a radiant slab"
  ...
  SingleCircuitSlab_PCM_fixed_Rx                     sla(
...
protected
  ...
  Buildings.Fluid.BaseClasses.MassFlowRateMultiplier masFloMul_b(
    ...
    "Mass flow multiplier, used to avoid having to instanciate multiple slab models"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  slPCMlib.Components.RadiantSlabs.BaseClasses.HeatFlowRateMultiplier heaFloMul_a(final k=
        nCir)
    "Heat flow rate multiplier, used to avoid having to instanciate multiple slab models"
    annotation (Placement(transformation(extent={{-40,20},{-60,40}})));
  slPCMlib.Components.RadiantSlabs.BaseClasses.HeatFlowRateMultiplier heaFloMul_b(final k=
        nCir)
    "Heat flow rate multiplier, used to avoid having to instanciate multiple slab models"
...
First implementation.
    ...
    Icon(graphics={
        ...
        Line(
          ...
          thickness=1,
          smooth=Smooth.None)}));
end ParallelCircuitsSlab_PCM_fixed_Rx;
