...
model SingleCircuitSlab_PCM "Model of a single circuit of a radiant slab"
  ...
  parameter Boolean insidePCM = false
    "If true, override the default k with PCM_layer.k";
...
equation
  ...
  connect(PCM_layer.port_a, con_a.port_b)
    annotation (Line(points={{0,30},{40,30},{40,40}}, color={191,0,0}));
  connect(PCM_layer.port_b, fluSlaCon.solid) annotation (Line(points={{-20,30},
          {-88,30},{-88,-70},{-28.4,-70}}, color={191,0,0}));
  annotation (
