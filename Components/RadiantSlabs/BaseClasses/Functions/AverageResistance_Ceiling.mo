within slPCMlib.Components.RadiantSlabs.BaseClasses.Functions;
function AverageResistance_Ceiling
...
algorithm
  ...
  if sysTyp == slPCMlib.Components.RadiantSlabs.Types.SystemType.Floor then
    alpha := kIns/dIns;
    assert(alpha < 1.212,
