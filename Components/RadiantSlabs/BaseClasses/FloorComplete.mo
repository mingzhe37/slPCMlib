...
model FloorComplete "Model of a floor of the building"
  ...
  final parameter Modelica.Units.SI.MassFlowRate mOut_flow[4]=0.3/3600*{VRooSou,
  ...
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam=weaName, computeWetBulbTemperature=false)
    "Weather data reader" annotation (Placement(transformation(extent={{-120,140},{-100,160}})));
  ...
  Buildings.Fluid.Sources.Outside out1(redeclare package Medium = Medium, nPorts=1)
                                                                                   "Outside condition"
    annotation (Placement(transformation(extent={{-148,36},{-128,56}})));
  ...
  parameter Modelica.Media.Interfaces.Types.Temperature T_start=293.15 "Start value of zone air temperature";
protected
...
equation
  ...
  connect(sou.ports[1],portsSou[1])
    annotation (Line(points={{162.4,-43.1},{164,-43.1},{164,-54},{86,-54},{86,-36},{85,-36}},color={0,127,255},smooth=Smooth.None));
  connect(sou.ports[2],portsSou[2])
    annotation (Line(points={{163.2,-43.1},{164,-43.1},{164,-54},{86,-54},{86,-36},{95,-36}}, color={0,127,255},smooth=Smooth.None));
  connect(eas.ports[1],portsEas[1])
    annotation (Line(points={{318.4,68.9},{300,68.9},{300,36},{325,36}},color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(eas.ports[2],portsEas[2])
    annotation (Line(points={{319.2,68.9},{300,68.9},{300,36},{335,36}},color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(nor.ports[1],portsNor[1])
    annotation (Line(points={{162.4,116.9},{164,116.9},{164,106},{88,106},{88,124},{85,124}},color={0,127,255},smooth=Smooth.None));
  connect(nor.ports[2],portsNor[2])
    annotation (Line(points={{163.2,116.9},{164,116.9},{164,106},{88,106},{88,124},{95,124}}, color={0,127,255},smooth=Smooth.None));
  connect(wes.ports[1],portsWes[1])
    annotation (Line(points={{30.4,58.9},{30,58.9},{30,44},{-35,44}},color={0,127,255},smooth=Smooth.None));
  ...
  connect(opeSouCor.port_a1,sou.ports[4])
    annotation (Line(points={{84,16},{74,16},{74,-20},{134,-20},{134,-54},{162,-54},{162,-46},{164,-46},{164,-43.1},
          {164.8,-43.1}},                                                                                                          color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeSouCor.port_b2,sou.ports[5])
    annotation (Line(points={{84,4},{74,4},{74,-20},{134,-20},{134,-54},{164,-54},{164,-43.1},{165.6,-43.1}},color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeEasCor.port_b1,eas.ports[4])
    annotation (Line(points={{270,54},{290,54},{290,68.9},{320.8,68.9}},color={0,127,255},smooth=Smooth.None,thickness=0.5));
  ...
  connect(opeNorCor.port_b1,nor.ports[4])
    annotation (Line(points={{100,90},{108,90},{108,106},{164,106},{164,116.9},{164.8,116.9}},color={0,127,255},smooth=Smooth.None,thickness=0.5));
  ...
  connect(sou.phi, multiplex5_2.u1[1])
    annotation (Line(points={{185,-14},{276,-14},{276,178},{338,178}}, color={0,0,127}));
  connect(eas.phi, multiplex5_2.u2[1])
    annotation (Line(points={{341,98},{350,98},{350,140},{310,140},{310,173},{338,173}}, color={0,0,127}));
  connect(nor.phi, multiplex5_2.u3[1])
    annotation (Line(points={{185,146},{220,146},{220,168},{338,168}}, color={0,0,127}));
  connect(wes.phi, multiplex5_2.u4[1])
  ...
  connect(weaDat.weaBus, weaBus) annotation (Line(
      points={{-100,150},{-100,148},{-80,148},{-80,200},{210,200}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
  ...
  connect(res.port_b, portsCor[1])
    annotation (Line(points={{-94,46},{-80,46},{-80,26},{85,26},{85,46}}, color={0,127,255}));
  connect(res1[1].port_b, portsSou[1])
    annotation (Line(points={{-96,80},{-80,80},{-80,-36},{85,-36}}, color={0,127,255}));
  connect(res1[2].port_b, portsEas[1])
    annotation (Line(points={{-96,80},{-80,80},{-80,26},{325,26},{325,36}}, color={0,127,255}));
  connect(res1[3].port_b, portsNor[1])
    annotation (Line(points={{-96,80},{-80,80},{-80,124},{85,124}}, color={0,127,255}));
  connect(res1[4].port_b, portsWes[1])
    annotation (Line(points={{-96,80},{-80,80},{-80,44},{-35,44}}, color={0,127,255}));
  connect(weaBus, bou[1].weaBus) annotation (Line(
      points={{210,200},{-160,200},{-160,80.2},{-148,80.2}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(weaBus, out1.weaBus) annotation (Line(
      points={{210,200},{-160,200},{-160,46.2},{-148,46.2}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
