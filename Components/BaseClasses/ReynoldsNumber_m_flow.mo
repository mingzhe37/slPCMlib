...
function ReynoldsNumber_m_flow "Return Reynolds number from m_flow, mu, D, A"
  ...
  input Modelica.Units.SI.Length D "Characteristic dimension (hydraulic diameter of pipes or orifices)";
  input Modelica.Units.SI.Area A=Modelica.Constants.pi/4*D*D "Cross sectional area of fluid flow";
